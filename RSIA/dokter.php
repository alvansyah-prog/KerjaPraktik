                          ...
                          <div class="card">
                            ...
                            <div class="card-body card-block">
                              <form method="post" action="<?php echo $_SERVER["PHP_SELF"]; ?>" class="form-horizontal">
                                ...
                                $tipe = "";
                              include 'koneksi.php';
                                if (isset($_GET['id_editdokter']))
                                {
                                  $id_dokter = $_GET['id_editdokter'];
                                  $database = "SELECT id_dokter, nama_dokter, tipedokter FROM dokter WHERE id_dokter = $id_dokter";
                                ...
                                <div class="row form-group">
                                    <div class="col col-sm-5"><label for="nama_dokter" class=" form-control-label">Nama Dokter</label></div>
                                    <div class="col col-sm-6">
                                      <input type="text" name="nama_dokter" value="<?php echo $nama; ?>">
                                    </div>
                                </div>
                                <div class="row form-group">
                                    <div class="col col-sm-5"><label for="tipedokter" class=" form-control-label">Spesialis Dokter</label></div>
                                    <div class="col col-sm-6">
                                      <select class="" name="tipedokter">
                                        <option value="Spesialis Anak" <?php if('Spesialis Anak'==$tipe) { echo 'selected';}?> > Spesialis Anak</option>
                                        <option value="Spesialis Kandungan" <?php if('Spesialis Kandungan'==$tipe) { echo 'selected';}?> >Spesialis Kandungan</option>
                                      </select>
                                    </div>
                                </div>
                              ...
                              <div class="card-footer">
                                ...
                                if(isset($_POST['Input'])) {
                                  ...
                                  $tipe = $_POST['tipedokter'];
                                if (!$kon){
                                  die("Koneksi database gagal:".mysqli_connect_error());
                                }
                                // Insert user data into table
                                $result = mysqli_query($kon, "INSERT INTO dokter(id_dokter,nama_dokter,tipedokter) VALUES('$id','$nama','$tipe')");
                                }
                                }
                                //catch exception
                                catch(Exception $e) {
                                ...
                                $result = mysqli_query($kon,"UPDATE `dokter` SET `id_dokter`='$id_update', `nama_dokter`='$nama', `tipedokter`='$tipe' WHERE `id_dokter`='$id_update'");
                                ...
                                <table class="table">
                                  ...
                                  <tbody>
                                    <tr>
                                      ...
                                      <td><?php echo $a['tipedokter']; ?></td>
                                      <td>
                                        <a class="btn btn-primary btn-sm" href="?id_editdokter=<?php echo $a['id_dokter']; ?>">Edit</a>
                                        <?php
                                        echo '
                                        <a href="delete_dokter.php?id_dokter='.$a['id_dokter'].'" class="btn btn-danger btn-sm" onclick="return confirm(\'Yakin ingin menghapus data ini?\')">Delete</a>
                                            '
                                        ?>
                                      </td>
                                    </tr>
