                    ...
                    <div class="page-header float-right">
                        <div class="page-title">
                            <ol class="breadcrumb text-right">
                                ...
                                <li class="active">Tabel Tanya Jawab</li>
                            </ol>
                        </div>
                    </div>
                </div>
                      ...
                      <div class="col-lg">
                          <div class="card">
                            <div class="card-header">
                                  <strong class="card-title">Insert Tabel Tanya Jawab</strong>
                            </div>
                            <div class="card-body card-block">
                              <form method="post" action="<?php echo $_SERVER["PHP_SELF"]; ?>" class="form-horizontal">
                                ...
                                $jawaban = "";
                              include 'koneksi.php';
                                if (isset($_GET['id_edittanya']))
                                {
                                  $id_tanya = $_GET['id_edittanya'];
                                  $database = "SELECT id_tanya ,Pertanyaan, Jawaban FROM tanyajawab WHERE id_tanya = '$id_tanya'";
                                ...
                                <input type="text" name="id_update" value="<?php echo $id; ?>" hidden >
                                  <div class="row form-group">
                                    <div class="col col-sm-5"><label for="id_tanya" class=" form-control-label">Id Tanya</label></div>
                                    <div class="col col-sm-6">
                                      <input type="text" size="100"  name="id_tanya" value="<?php echo $id; ?>">
                                    </div>
                                </div>
                                <div class="row form-group">
                                    <div class="col col-sm-5"><label for="pertanyaan" class=" form-control-label">Pertanyaan</label></div>
                                    <div class="col col-sm-6">

                                      <input type="text" size="100" name="pertanyaan" value="<?php echo $pertanyaan; ?>">
                                    </div>
                                </div>
                                <div class="row form-group">
                                    <div class="col col-sm-5"><label for="jawaban" class=" form-control-label">Jawaban</label></div>
                                    <div class="col col-sm-6">
                                      <input type="text" size="100"  name="jawaban" value="<?php echo $jawaban; ?>">
                                    </div>
                                </div>
                              <div class="card-footer">
                                ...
                                $result = mysqli_query($kon, "INSERT INTO tanyajawab(id_tanya,pertanyaan,jawaban) VALUES('$id','$pertanyaan','$jawaban')");
                                }
                                }
                                //catch exception
                                catch(Exception $e) {
                                ...
                                $result = mysqli_query($kon,"UPDATE `tanyajawab` SET `id_tanya`='$id_update', `pertanyaan`='$pertanyaan', `jawaban`='$jawaban' WHERE `id_tanya`='$id_update'");
                              ...
                              <div class="card-body">
                                <table class="table">
                                  ...
                                  <?php
                                  include 'koneksi.php';
                                  $database = "SELECT * FROM tanyajawab  ";
                                  $query = mysqli_query($kon,$database);
                                  while ($a=mysqli_fetch_array($query)) {
                                  ?>
                                  ...
                                  <tbody>
                                    <tr>
                                      <td><?php echo $a['id_tanya']; ?></td>
                                      <td><?php echo $a['Pertanyaan']; ?></td>
                                    <td><?php echo $a['Jawaban']; ?></td>
                                      <td>
                                        <a class="btn btn-primary btn-sm" href="?id_edittanya=<?php echo $a['id_tanya']; ?>">Edit</a>
                                        <?php
                                        echo '
                                        <a href="delete_tanya.php?id_tanya='.$a['id_tanya'].'" class="btn btn-danger btn-sm" onclick="return confirm(\'Yakin ingin menghapus data ini?\')">Delete</a>
                                            '
                                        ?>
                                      </td>
                                    </tr>
